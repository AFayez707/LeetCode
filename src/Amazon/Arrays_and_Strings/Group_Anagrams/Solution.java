package Amazon.Arrays_and_Strings.Group_Anagrams;
...
public class Solution {
    ...
    public static void main(String[] args) {
        System.out.println(new Amazon.Arrays_and_Strings.Group_Anagrams.Solution().groupAnagrams(new String[]{"hi", "ih"}));
    }
}
